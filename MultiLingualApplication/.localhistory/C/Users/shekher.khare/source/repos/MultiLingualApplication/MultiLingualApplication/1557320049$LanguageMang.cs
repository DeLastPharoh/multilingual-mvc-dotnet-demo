...
namespace MultiLingualApplication
{
    ...
    {
        public static List<Languages> supportedLanguages = new List<Languages> {
            new Languages {
        ...
        {
            return supportedLanguages.Where(a => a.LanguageCultureName.Equals(language)).SingleOrDefault() != null ? true : false;
        }
        public static string GetDefaultLanguage()
        {
            return supportedLanguages[0].LanguageCultureName;
        }
